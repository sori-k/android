...
public class PostActivity extends AppCompatActivity { //post는 Firestore Database로
    FirebaseUser user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnWrite).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PostActivity.this, WriteActivity.class); //post activity에서 write activity로
    ...
    //데이터 읽어오기
    public void getList(){ //collection은 테이블 지정
        db.collection("post")
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        array.clear();
                        for(QueryDocumentSnapshot doc:task.getResult()){ //가져온 데이터를 하나씩 doc에 들어있다.
